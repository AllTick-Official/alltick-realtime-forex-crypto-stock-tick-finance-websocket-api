...
- **Base Path:** `/quote-stock-b-api/v1/kline`
- **Full URL:** `https://quote.alltick.co/quote-stock-b-api/v1/kline/{query}`

2.**Forex, Precious Metals, Cryptocurrencies, Commodities API Endpoints:**

- **Base Path:** `/quote-b-api/v1/kline`

- **Full URL:** `https://quote.alltick.co/quote-b-api/v1/kline/{query}`
...
| query      | path    | string | Yes      | See explanation for query request parameter below     |
