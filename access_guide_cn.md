...
### 第6步：请求具体接口获取你想要的数据
#### rest接口
- [批量获取最新成交价(最新价、当前价)](./rest_interface/latest_transaction_price_query_cn.md)
- [获取最新盘口(Order Book)](./rest_interface/latest_order_book_price_query_cn.md)
- [获取单个产品历史K线（最高、最低、开盘、收盘价）](./rest_interface/kline_query_cn.md)
- [批量获取产品最新2根K线（最高、最低、开盘、收盘价）](./rest_interface/batch_kline_query_cn.md)
- [获取股票产品基础信息](./rest_interface/static_query_cn.md)
...
- 备用官网：[https://alltickapi.com](https://alltickapi.com)
