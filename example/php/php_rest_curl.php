...
// Build the URL with the encoded query in the path
// Format: https://quote.alltick.co/quote-stock-b-api/v1/kline/{query}
$url = 'https://quote.alltick.co/quote-stock-b-api/v1/kline/' . rawurlencode($params);
$method = 'GET';
